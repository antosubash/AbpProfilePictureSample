...
{
    public static class ProfilePictureSampleEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE ProfilePictureSampleModuleExtensionConfigurator CLASS (in the Domain.Shared project)
